...
echo  "|                                                           |" | lolcat
echo  "|              Root®Autor      : H4CK3RS404                 |" | lolcat
echo  "|              Youtube         : RD TUTORIAL                |" | lolcat
echo  "|              Thanks to       : SUBSCRIBERS                |" | lolcat
...
echo $i"========================================"
echo
echo $me"┌==="$bi"["$i"H4CK3RS404"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"Youtube :"$i" RD TUTORIAL"
echo $ku"Facebook :"$i" HANTU GAJE"
echo $ku"Instagram :"$i" rd_shop.01"
sleep 2
